...
var checkComplete = function() {
  ...
  if (++completeCount == num) {
    ...
    var chat = addChatMessage("",
      '<center style="line-height:0em; box-sizing:border-box;">' +

      '<div style="display:inline-block; font-size:' + width + ";" +
                  'padding:0.0em; background:black">' +

      '<div style="padding:0.0em; border:0.0em solid white; ' +
                  "display:inline-block !important; white-space:pre !important;" +
                  "font-size:" + width + "; line-height:0em; color:white !important;" +
